...
int main()
{
    ...
    while(Tests--)
    {
        ll x;
        cin>>x;
        while(x>=7 && x%3!=0)///7 er cheye boro, jotokkhon na porjontoh 3 er multiple pai.
                            ///while loop tah duita khetre bhangbe, either x 7 er cheye choto hoye jabe
                            ///or x will be divisible by 3.
        {
            x-=7;
        }
        if(x%3)
        {
            cout<<"NO"<<endl;///Jodi remaining x divisible by 3 na hoy.
        }
        else
        {
            cout<<"YES"<<endl;///Jodi hoy.
        }
    }
    Bye;
}
