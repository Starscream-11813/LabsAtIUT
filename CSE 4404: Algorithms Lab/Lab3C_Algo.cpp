...
int main()
{
    ...
    while(Tests--)
    {
        ...
        bitset<100*500>possibleSums;///To handle worst case where, there will be 100 500c coins.
                                    ///idx true hoile, idx is a possible subsq sum.
        sort(all(a));
        possibleSums[0]=1;///Zero is of course valid if we don't pick any coin.
        REP(i,m)
        {
            auto ORoperand=possibleSums<<a[i];///apatoto jei jei subsq sum paisi oigular shathe a[i] add korle jah ashbe oitao ekta possible subsq sum.
            possibleSums|=ORoperand;
        }
