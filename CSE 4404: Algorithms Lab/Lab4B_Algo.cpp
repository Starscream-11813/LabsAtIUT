...
int main()
{
    ...
    while(true)
    {
        ...
        ll res=0;///res eh thakbe amar final cost.
        while(mh.size()>=2)///min heap eh 2 or more elements thaka porjontoh chalay jabo, ultimately ekta thakbe jeita amar final sum.
        {
            ///Cost Minimize korar jonno amar targer least 2 ta numbers add kora in every step.
            ll sum=0;
            sum+=mh.top();
            mh.pop();
            sum+=mh.top();
